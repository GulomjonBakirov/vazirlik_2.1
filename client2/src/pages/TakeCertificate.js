...
import "../styles/certificate/certificate.css";
    ...
    <div className="mb-4">
      <section id="sertificat" ref={ref}>
        <div class="sertf">
          ...
          <div class="serBot">
            <QRCode
              value={`http://165.232.152.230:3000/${user.user._id}`}
              bgColor="white"
              size={124}
            />
            <div class="dir">
...
export default function FullCertificate() {
  ...
  return (
    <div>
      ...
      <ReactToPrint
        trigger={() => (
          <button class="btn btn-success  printSertf">
            <svg
